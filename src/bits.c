...
/*
    ...
    size_t data_end_byte = (start_bit + length) / 8;
    size_t data_start_byte = start_bit / 8;
    size_t field_byte_size = (length / 8) + 1;
    ...
    for (size_t index = 0 ; index <= field_byte_size - 1; index++) {
        ...
        size_t data_index = data_size - 1 - index - data_start_byte;
        size_t field_index =  field_byte_size -1  - index;
        bool is_last_byte = index == field_byte_size - 1;
